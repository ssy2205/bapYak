      ...
      >
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-black text-white font-bold py-5 rounded-none mt-4 shadow-none hover:bg-white hover:text-black active:scale-95 transition-all border-[1.5px] border-black"
          >
            입력 완료!
          </button>
        </div>
