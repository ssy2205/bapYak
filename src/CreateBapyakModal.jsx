  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-2xl font-black mb-8 text-center text-black">새로운 밥약 등록</h2>
        <div className="space-y-6">
          ...
          <div className="relative">
            <Instagram className="absolute left-5 top-6 text-black" size={24} />
            <input
              id="instagramId"
              onChange={handleChange}
          ...
          <div className="relative">
            <Calendar className="absolute left-5 top-6 text-black" size={24} />
            <input
              type="date"
              value={formData.date}
          ...
          <div className="relative">
            <AlignLeft className="absolute left-5 top-6 text-black" size={24} />
            <textarea
              id="intro"
              onChange={handleChange}
